...
## Collections includes high performing container datatypes
...
class Actor():
    ...
    def build_model(self):
      ...
      # Define Optimizer & Training Function
      optimizer = optimizers.Adam(lr=0.0001)           #Common Optimizer
...
class Critic:
    ...
    def build_model(self):
        ...
        # Combine State & Action Pathways
        net = layers.Add()([net_states, net_actions])
        net = layers.Activation('relu')(net) #Could adjust # of layers in here if necessary
...
class DDPG():
    """Reinforcement Learning agent that learns using Deep Deterministic Policy Gradients."""
    ...
    def learn(self, experiences):
        ...
        # Convert experience tuples to separate arrays for each element - see below
        ...
        Q_targets = rewards + self.gamma * Q_targets_next * (1 - dones) #Calls from above & then runs model call
